/**
  ...
  $Revision: 40612 $
  $Date: 2016-01-16 19:30:18 +0100 (lø, 16 jan 2016) $
...
properties = {
  ...
  outPutCoolant: false, // optional stop
...
function onOpen() {
  ...
  switch (unit) {
  case IN:
    writeBlock(gUnitModal.format(20), gAbsIncModal.format(90), gFormat.format(40));
    break;
  case MM:
    writeBlock(gUnitModal.format(21), gAbsIncModal.format(90), gFormat.format(40));
    break;
  }
...
function onSection() {
  ...
  if (insertToolCall) {
    ...
    retracted = true;
  if (properties.outPutCoolant == true){
